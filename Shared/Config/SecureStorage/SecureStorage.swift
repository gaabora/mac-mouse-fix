...
/// - All settings are stored in a dictionary inside a single keychain item labeled 'com.ft07.mac-mouse-fix.secure-storage'.
...
@objc class SecureStorage: NSObject {
    ...
    private static let label = "com.ft07.mac-mouse-fix.secure-storage" /// "MFSecureStorage"
